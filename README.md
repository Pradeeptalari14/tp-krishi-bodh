# 🌾 Krishi Bodh (Indian Agriculture Chatbot)

> Voice assistant for farmers. Integrates WhatsApp and Telegram voice notes and provides farming answers.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/krishi-bodh/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-krishi-bodh.git
cd tp-krishi-bodh
```
...
```bash
kubectl port-forward deployment/tp-krishi-bodh 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── krishi_bodh.py     # Main configuration file
```
...
---
*Generated by [Krishi Bodh (Indian Agriculture Chatbot) Studio](https://pradeeptalari14.github.io/portfolio/tools/krishi-bodh/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
